...
..  figure:: ./images/PSCAD/TheveninPSCAD.png
    ...
    :target: _images/TheveninPSCAD.png

    Figure 1: Thevenin equivalent connect to PCC in PSCAD™.
...
..  figure:: ./images/PSCAD/SMIB_IBR_PSCAD.png
    ...
    :target: _images/SMIB_IBR_PSCAD.png
    :width: 50%

    Figure 2: IBR in a SMIB configuraiton in PSCAD™.
...
..  figure:: ./images/PSCAD/PSCADMeasurementmodel.png
    ...
    :target: _images/PSCADMeasurementmodel.png
    :width: 50%

    Figure 3: IBR in a SMIB configuraiton containing the DLL relevant measurements in PSCAD™.
...
The measurement names for the phase-to-ground voltage and current are then defined for each phase (see Figure 4 & 5).

.. container:: image-row

    ..  figure:: ./images/PSCAD/Multimeter.png
        :alt: PSCAD™ multimeter configuration pane of the phase a measurement at the PCC.
        :target: _images/Multimeter.png

        Figure 4: PSCAD™ multimeter configuration pane of the phase a measurement at the PCC.

        
    ..  figure:: ./images/PSCAD/Multimeter2.png
        :alt: PSCAD™ multimeter signal names pane of the phase a measurement at the PCC.
        :target: _images/Multimeter2.png

        Figure 5: PSCAD™ multimeter signal names pane of the phase a measurement at the PCC.
...
To start the importer, double-click the executable file. This opens a Python-based Tkinter graphical user interface (see Figure 6). 

..  figure:: ./images/PSCAD/IECImporterPSCAD.png
    :alt: GUI of the PSCAD™ IEC 61400-27 DLL importer.
    :target: _images/IECImporterPSCAD.png
    :width: 50%

    Figure 6: GUI of the PSCAD™ IEC 61400-27 DLL importer.
...
..  figure:: ./images/PSCAD/IECImporterPSCAD2.png
    ...
    :target: _images/IECImporterPSCAD2.png
    :width: 50%

    Figure 7: Filled GUI of the PSCAD™ IEC 61400-27 DLL importer.
...
..  figure:: ./images/PSCAD/IECImporterPSCAD3.png
    ...
    :target: _images/IECImporterPSCAD3.png
    :width: 50%

    Figure 8: IEC DLL Model Block for the control of the IBR in a SMIB configuraiton containing the DLL relevant measurements in PSCAD™.
...
..  figure:: ./images/PSCAD/IECImporterPSCAD4.png
    ...
    :target: _images/IECImporterPSCAD4.png
    :width: 50%

    Figure 9: Connection of the PSCAD™ signals to the IEC DLL Model Block in PSCAD™.    
...
.. container:: image-row
    ...
    ..  figure:: ./images/PSCAD/IECBlockConfiguration.png
        ...
        :target: _images/IECBlockConfiguration.png

        Figure 10: Configuration pane of the IEC 61400-27 DLL PSCAD™ block.

    ..  figure:: ./images/PSCAD/IECBlockModelparameter.png
        :alt: Model Parameters pane of the IEC 61400-27 DLL PSCAD™ block.
        :target: _images/IECBlockModelparameter.png

        Figure 11: Model Parameters pane of the IEC 61400-27 DLL PSCAD™ block.

    ..  figure:: ./images/PSCAD/IECBlockInitialconditions.png
        :alt: Initial Conditions pane of the IEC 61400-27 DLL PSCAD™ block.
        :target: _images/IECBlockInitialconditions.png

        Figure 12: Initial Conditions pane of the IEC 61400-27 DLL PSCAD™ block.
...
The ``Configuration`` menu contains the basic DLL settings (see Figure 10). 
Here, the DLL path can be specified and interpolation can be enabled or disabled. 

The ``Model Parameters``, in contrast, directly influence the behavior of the inverter model (see Figure 11). 

The ``Initial Conditions`` can be used to define the initial values applied up to the specified ``TRelease`` time (see Figure 12). 
